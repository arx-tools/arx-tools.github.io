import { Group, Timer, PerspectiveCamera, Raycaster, Vector3, MathUtils } from 'three';
import * as PlayerUtils from './playerUtils.js';
import * as InputUtils from './inputUtils.js';
export class CharacterController {
    scene;
    constructor(scene, { walkSpeed = 5,
    /*
    walkSpeed = 5,
    sprintSpeed = 10,
    floorDistance = 1,
    ...
    */
        ...
        this.isGrounded;
        this.velocity = 0;
        this.raycaster = new Raycaster(this.player.position, new Vector3(0, 0, -1), 0, this.floorDistance);
    ...
    update() {
        ...
        this.player.position.z = this.player.position.z + this.velocity * delta;
